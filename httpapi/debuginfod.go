...
func (h *Handler) debuginfodDebug(w http.ResponseWriter, r *http.Request) {
	h.serveELF(w, r, resolver.FileELFDebug, placeholderDebug, "debuginfo")
}
...
func (h *Handler) debuginfodExecutable(w http.ResponseWriter, r *http.Request) {
	h.serveELF(w, r, resolver.FileELFCode, placeholderExecutable, "executable")
}

func (h *Handler) serveELF(w http.ResponseWriter, r *http.Request, ft resolver.FileType, placeholder, label string) {
...
func (h *Handler) debuginfodSource(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", symstore.OctetStream)
	recordRequest(http.StatusOK, label)
